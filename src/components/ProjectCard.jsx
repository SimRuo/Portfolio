...
import DissolveImage from './DissolveImage.jsx'
    ...
    >
      ...
      >
        ...
        <Box sx={{ p: 2.25, display: 'flex', flexDirection: 'column', gap: 1.25, flex: 1 }}>
          <Typography variant="h5" component="h3" sx={{ fontWeight: 800, fontSize: '1.15rem', textTransform: 'none', letterSpacing: '-0.01em' }}>
            {copy.title}
          </Typography>
          <Typography
            variant="subtitle1"
            sx={{ color: 'primary.light', fontStyle: 'italic', fontWeight: 500, fontSize: '0.92rem' }}
          >
            {copy.tagline}
          </Typography>
          ...
          <Box sx={{ mt: 'auto', pt: 1, display: 'flex', justifyContent: 'flex-end' }}>
            <Typography component="span" className="card-arrow" sx={{ color: 'text.secondary', transition: 'transform 140ms, color 140ms', fontSize: '1.1rem' }}>
              →
            </Typography>
          </Box>
        </Box>
